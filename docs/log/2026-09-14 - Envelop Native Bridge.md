...
<p align="center">
  <img src="../../web/assets/gallery/envelop/logs/envelop-tomato-fpga-framebuffer.webp" width="70%" alt="Envelop inside Tomato OS with the bridge online on the FPGA framebuffer">
</p>
<p align="center"><em>The hardware-side destination behind the native bridge work; dated evidence, not current availability.</em></p>
