...
HD_PWD='C:/Users/Tyrone/OneDrive/Documents/GitHub/tomato/hardware/fpga/hex_display/hex_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_seg.tcl -notrace
