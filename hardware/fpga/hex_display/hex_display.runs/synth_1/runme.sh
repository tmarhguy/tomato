...
HD_PWD='C:/Users/Tyrone/OneDrive/Documents/GitHub/tomato/hardware/fpga/hex_display/hex_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex_seg.tcl
