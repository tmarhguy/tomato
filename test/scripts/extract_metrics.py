#!/usr/bin/env python3
"""Parse Yosys synth.log and write reports/metrics.txt (Kogge-Stone benchmark)."""
...
NETLIST = "rtl/kogge_stone_32.v"
TOP = "kogge_stone_32"
DESIGN = "Kogge-Stone 32-bit adder (fastest classical prefix topology)"
...
def main() -> int:
    ...
    lines.extend(
        [
            ...
            "",
            "## Timing (liberty arc estimate on LTP prefix path)",
